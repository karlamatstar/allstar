...
from allstar.ai_agent.evaluation.quality_pipeline import TEST_CASE_FILE, load_test_cases, run_pipeline

SAMPLE_SIZE = 2


def test_pipeline_generates_reports(tmp_path, monkeypatch):
    import allstar.ai_agent.evaluation.quality_pipeline as pipeline
