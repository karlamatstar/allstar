...
$reports = Join-Path $ProjectRoot "_OUTPUT\reports\voc\testcase"
$logs = Join-Path $ProjectRoot "_OUTPUT\logs\voc\testcase"
...
$casesJson = Join-Path $ProjectRoot "src\allstar\voc\evaluation\test_cases.json"
