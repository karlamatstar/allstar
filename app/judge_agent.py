...
from app.concurrency import BACKOFF_BASE_SECONDS, openai_call_semaphore
from app.config import OPENAI_API_KEY, OPENAI_MODEL
from app.knowledge_base import COURSE_KNOWLEDGE
from app.metrics import agent_retry_total, agent_unavailable_total
